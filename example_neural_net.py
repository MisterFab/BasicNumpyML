...
def train_neural_net_mlp(X_train, y_train, num_epochs=100, learning_rate=0.01, batch_size=64):
    ...
    for epoch in range(num_epochs):
        ...
        for i in range(num_batches):
            ...
            mse_accumulated += compute_mse(a_out, model._int_to_onehot(y_batch, num_classes))
        ...
        avg_mse_for_epoch = mse_accumulated / num_batches
        
        if epoch % 10 == 0:
            print(f"Epoch: {epoch}, MSE: {avg_mse_for_epoch:.5f}")
